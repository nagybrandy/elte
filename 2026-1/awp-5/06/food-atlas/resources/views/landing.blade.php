      ...
      <div class="hero-content text-left text-primary-content relative z-10 container mx-auto px-4 lg:px-8 py-28 lg:py-40">
        <div class="max-w-2xl">
          ...
          <div class="flex flex-wrap gap-4">
            <a href={{route("recipes.index") }} class="btn btn-accent btn-lg shadow-lg transition-all">
              Browse Recipes
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
            </a>
            <a href={{route("recipes.create") }} class="btn btn-outline btn-lg text-primary-content border-primary-content/40 hover:bg-primary-content/15 hover:border-primary-content/60 shadow-lg hover:shadow-xl transition-all">Create Your Own</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="py-16 lg:py-24">
      <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <!-- Card 1 -->
          <a href="{{ route('recipes.show', $recipe) }}" class="card bg-base-200 shadow-lg hover:shadow-2xl transition-all duration-300 border border-base-300 hover:border-primary/30 group">
        ...
        <div class="flex justify-center mt-8 sm:hidden">
          <a href={{route("recipes.index") }} class="btn btn-outline hover:bg-base-200">
            View all recipes
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
          </a>
        </div>
