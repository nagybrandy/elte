<nav class="navbar bg-white/90 backdrop-blur-lg sticky top-0 z-50 border-b border-base-300 shadow-sm">
    ...
    <div class="navbar-end gap-2">
      ...
      <a href="{{ route('profile.edit') }}" class="btn btn-primary btn-sm hidden lg:flex">{{auth()->user()->name}}</a>
