...
const _excluded$$ = ["children", "noCell"];
const TableHead = /*#__PURE__*/React.forwardRef((_ref, ref) => {
  ...
  const renderChildren = noCell ? children : children == null ? void 0 : children.map((child, i) => i < 1 ? jsx("th", {
    children: child
  }, i) : jsx("td", {
    children: child
  }, i));
...
const _excluded$Z = ["children", "active", "hover", "noCell", "className"];
...
const _excluded$Y = ["children", "noCell"];
