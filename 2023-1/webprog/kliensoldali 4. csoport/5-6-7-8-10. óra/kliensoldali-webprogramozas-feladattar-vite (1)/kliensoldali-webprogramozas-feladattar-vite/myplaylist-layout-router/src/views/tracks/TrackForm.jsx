...
export function TrackForm({open, handleClose, handleSubmit, setFormState, formState, editTrack}) {
  ...
  return (
    <Modal as="form" className="ui modal" open={open} onClose={handleClose} onSubmit={handleSubmit}>
      <i className="close icon" onClick={handleClose}></i>
      <div className="header">{editTrack ? `Edit: ${editTrack.title}` : "Add new Track"}</div>
