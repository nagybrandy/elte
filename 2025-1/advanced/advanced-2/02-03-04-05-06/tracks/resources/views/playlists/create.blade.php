...
<div class="max-w-md p-5 mx-auto my-4">
    ...
    <form action="{{ route('playlists.create') }}" method="POST" class="flex flex-col space-y-4 rounded-lg bg-base-300">
        @csrf
        ...
        <fieldset class="fieldset">
            ...
            <textarea name="description" rows="4" 
                      class="w-full textarea" placeholder="Type here"></textarea>
        </fieldset>
