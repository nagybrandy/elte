...
// table6.querySelectorAll('td').forEach(e=> e.addEventListener('click', colorCell))
...
document.addEventListener('mouseover', (e)=> e.target.title = e.target.innerHTML)
// bubbling - delegation
table6.addEventListener('click', colorCell)
