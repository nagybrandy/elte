...
<body class="p-0">
    ...
    <div
        ...
        <?php foreach ($data as $player): ?>
            <div class="card card-side shadow-xl <?= $player['goals2024'] > 5 ? 'bg-green-800' : 'bg-red-800'?>">
                ...
                <div class="card-body mx-auto text-center w-full p-3 my-auto">
                    ...
                    <div class="card-actions mx-auto text-center block">
                        <?php foreach ($player['positions'] as $position): ?>
                            <div class="badge badge-primary"><?= $position ?></div>
                        <?php endforeach ?>
                        <div class="stat">
                            ...
                            <?php if ($player['goals2024'] > $player['goals2023']): ?>
                                <div class="stat-desc"><?= $player['goals2024'] - $player['goals2023'] ?> more than last season
                                </div>
                            <?php else: ?>
                                <div class="stat-desc"><?= $player['goals2023'] - $player['goals2024'] ?> less than last season
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
