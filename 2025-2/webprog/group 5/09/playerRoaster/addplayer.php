...
function validate(&$data, &$errors, &$form) {
    ...
    */
    ...
    // number of goals; if its an integer
    ...
    if(!isset($form['goals2024']) || strlen(trim($form['goals2024'])) === 0) {
        ...
        $data['goals2024'] = intval($form['goals2024']);
    }

    if(!isset($form['img'])) $data['img'] = "benke";
    $data['goals2023'] = 0;
...
<body>
    ...
    <div class="flex">
        <form action="addplayer.php" method="get" class="mx-auto mt-3 w-6/12 p-10">
